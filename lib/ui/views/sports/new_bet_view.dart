      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: PreferredSize(
              preferredSize:  Size.fromHeight(viewModel.selectedOption=='Search'? 120:70),
              child: SizedBox(
                ...
                child: Column(
                  children: [
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Container(
                              ...
                              padding:  EdgeInsets.symmetric(horizontal: MediaQuery.sizeOf(context).width*0.132),
                              decoration: BoxDecoration(
                                color:viewModel.selectedOption=='Search'? const Color(0xff0075FF):Colors.transparent,
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              alignment: Alignment.center,
                              decoration: BoxDecoration(
                                color:viewModel.selectedOption=='Custom'? const Color(0xff0075FF):Colors.transparent,
                                borderRadius: BorderRadius.circular(5)
                              ),
                              child: Text('Custom',style: Theme.of(context).textTheme.titleLarge,),
                            ),
                          ),
                        ],
                      ),
                    ...
                    10.verticalSpace,
                    viewModel.selectedOption=='Search'?  SizedBox(
                      width: MediaQuery.sizeOf(context).width*0.85,
                      child: TextField(
                   ...
                   if(viewModel.selectedOption=='Search')
                    20.verticalSpace,
                  ],
                ),
              )),
        ),
        backgroundColor: viewModel.selectedOption=='Search'? Colors.black:const Color(0xff111214),
        body: Container(
          padding: const EdgeInsets.only(left: 10.0, right: 10.0),
          child:
          viewModel.selectedOption=='Search'?
          DefaultTabController(length: viewModel.types.length, child:
              Column(
                children: [
                  TabBar(
                    ...
                    tabs:  [
                      Tab(text: viewModel.types[0],),
                      Tab(text: viewModel.types[1], ),
                      Tab(text: viewModel.types[2],),
                    ],
                  ),
                  Expanded(
                    child: TabBarView(
                      children: [
                       ...
                       Container(
                         ...
                         width: MediaQuery.sizeOf(context).width,
                           ...
                           child: const BetCardsListView(itemCount: 10, widget: BetCard(), separator: SizedBox(height: 15,)))
                      ],
                    ),
                  )
                ],
          ...
          Column(
            ...
            children: [
              const SizedBox(height: 15,),
               Text('Event Type',style: GoogleFonts.manrope(
                   color:  Colors.white,
                   fontWeight: FontWeight.w600,
                  fontSize:16
              ),),
              ...
              Container(
                ...
                child:  Row(
                  ...
                  children: [
                    Text('NBA',style: GoogleFonts.manrope(
              ...
              Text('Team 1',style: GoogleFonts.manrope(
                  color:  Colors.white,
                  fontWeight: FontWeight.w600,
                  fontSize:16
              ),),
              ...
              Text('Team 2',style: GoogleFonts.manrope(
                  color:  Colors.white,
                  fontWeight: FontWeight.w600,
                  fontSize:16
              ),),
