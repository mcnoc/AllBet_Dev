...
class SoccerCard extends StatelessWidget {
  const SoccerCard(
      {super.key, required this.openers, required this.fullCardView});
          ...
          Row(
            ...
            children: [
              Text(
                'Caesars: +4½ -105',
                style: GoogleFonts.manrope(
                    color: const Color(0xffB8C0CA), fontSize: 12),
              ),
              SizedBox(
                width: 10,
              ),
              Text(
                '53%',
                style: GoogleFonts.manrope(color: Colors.green, fontSize: 12),
              ),
              const SizedBox(
                width: 10,
              ),
              ...
              Text(
                '47%',
                style: GoogleFonts.manrope(
                    color: const Color(0xffF66F6F), fontSize: 12),
              ),
              const SizedBox(
                width: 10,
              ),
